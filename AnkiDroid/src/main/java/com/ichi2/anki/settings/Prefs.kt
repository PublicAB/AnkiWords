...
open class PrefsRepository(
    ...
    val hideQuestionText by booleanPref(R.string.hide_question_text_key, defaultValue = false)
    ...
    /**
     * Number of times each sound is played automatically when a card is displayed.
     * Stored as a string by [androidx.preference.EditTextPreference]; invalid input falls back to 1.
     */
    val audioAutoplayCount: Int
        get() = getString(R.string.audio_autoplay_count_key, "1")?.toIntOrNull()?.coerceIn(1, MAX_AUDIO_AUTOPLAY_COUNT) ?: 1
    ...
    companion object {
        ...
        /** Sanity cap for [audioAutoplayCount] to avoid absurd values */
        private const val MAX_AUDIO_AUTOPLAY_COUNT = 999
    }
}
